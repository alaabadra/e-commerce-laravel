...
############################products-attributes######################################
Route::group(['prefix'=>'product-attributes','namespace'=>'User'],function(){
    ...
    ############################languages######################################
    Route::group(['prefix'=>'languages','namespace'=>'User'],function(){
       

    });
############################similarProducts######################################
Route::group(['prefix'=>'similar-products','namespace'=>'User'],function(){
